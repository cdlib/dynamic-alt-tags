...
define( 'WPAI_ALT_TEXT_VERSION', '0.1.4' );
...
define( 'WPAI_ALT_TEXT_UPDATE_PACKAGE_URL', 'https://satzman.com/plugin-updates/dynamic-alt-tags/dynamic-alt-tags-0.1.4.zip' );

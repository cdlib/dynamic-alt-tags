...
define( 'WPAI_ALT_TEXT_VERSION', '1.0.8' );
...
define( 'WPAI_ALT_TEXT_UPDATE_PACKAGE_URL', 'https://cdlib.org/services-groups/webprod/plugins/dynamic-alt-tags/files/dynamic-alt-tags-1.0.8.zip' );

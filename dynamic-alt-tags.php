...
define( 'WPAI_ALT_TEXT_VERSION', '1.0.3' );
...
define( 'WPAI_ALT_TEXT_UPDATE_PACKAGE_URL', 'https://cdlib.org/services-groups/webprod/plugins/dynamic-alt-tags/dynamic-alt-tags-1.0.3.zip' );

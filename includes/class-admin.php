...
class WPAI_Alt_Text_Admin {
	...
	private function get_settings_metrics_fields() {
		...
		return array(
			...
			'ai-alt-metric-processed-this-week'      => number_format_i18n( isset( $metrics['weekly_images_processed'] ) ? absint( $metrics['weekly_images_processed'] ) : 0 ),
			'ai-alt-metric-processed-this-month'     => number_format_i18n( isset( $metrics['monthly_images_processed'] ) ? absint( $metrics['monthly_images_processed'] ) : 0 ),
			'ai-alt-metric-processed-this-year'      => number_format_i18n( isset( $metrics['yearly_images_processed'] ) ? absint( $metrics['yearly_images_processed'] ) : 0 ),
